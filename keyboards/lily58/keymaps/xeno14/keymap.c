...
[_LOWER] = LAYOUT( \
  ...
  _______, KC_GRV,  _______, _______, _______, KC_F11,                    KC_F12, KC_PIPE, _______,_______, _______, _______,\
  _______, KC_EXLM, KC_AT,   KC_HASH, KC_DLR,  KC_PERC,                   KC_CIRC, KC_AMPR, KC_ASTR, KC_LPRN, KC_RPRN, _______, \
  _______, _______, _______, _______, _______, _______, KC_LCBR, KC_RCBR, XXXXXXX, KC_PLUS, KC_PLUS, KC_LABK, KC_RABK, _______, \

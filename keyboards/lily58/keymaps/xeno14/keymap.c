 ...
 * `-----------------------------------------/       /     \      \-----------------------------------------'
 *                   |LCTRL | LAlt |LOWER | /Space  /       \Enter \  |RAISE |BackSP| RSFT |
 *                   |      |      |      |/       /         \      \ |      |      |      |
 *                   `----------------------------'           '------''--------------------'
 */

 [_QWERTY] = LAYOUT( \
  KC_GESC,  KC_1,   KC_2,    KC_3,    KC_4,    KC_5,                     KC_6,    KC_7,    KC_8,    KC_9,    KC_0,    TDMINS, \
  KC_TAB,   KC_Q,   KC_W,    KC_E,    KC_R,    KC_T,                     KC_Y,    KC_U,    KC_I,    KC_O,    KC_P,    KC_EQL, \
  KC_LCTRL, KC_A,   KC_S,    KC_D,    KC_F,    KC_G,                     KC_H,    KC_J,    KC_K,    KC_L,    TDCLN,   KC_QUOT, \
  KC_LSFT,  KC_Z,   KC_X,    KC_C,    KC_V,    KC_B, TDLPR,    TDRPR,    KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_RGUI, \
                             KC_LCTRL,KC_LALT, LOWER,KC_SPC,   KC_ENT,   RAISE,   KC_BSPC, KC_RSFT \
),
/* LOWER
 * ,-----------------------------------------.                    ,-----------------------------------------.
...
[_LOWER] = LAYOUT( \
  ...
  _______, KC_GRV,  _______, _______, _______, _______,                   _______, KC_PIPE, _______,_______, _______, KC_BSLS,\
  _______, KC_EXLM, KC_AT,   KC_HASH, KC_DLR,  KC_PERC,                   KC_CIRC, KC_AMPR, KC_ASTR, KC_LPRN, KC_RPRN, KC_TILD, \
  _______, _______, _______, _______, _______, _______, KC_LCBR, KC_RCBR, XXXXXXX, KC_UNDS, KC_PLUS, KC_LCBR, KC_RCBR, _______, \

...
[_QWERTY] = LAYOUT( \
      ...
      ADJUST,  KC_LGUI, LALTCTL, KC_LALT, MSFTTAB, LOWER, KC_SPC,  KC_ENT,  RAISE, KC_BSPC, KC_EQL,  KC_MINS, KC_LBRC, KC_RBRC  \
      ),
  /* Colemak
   * ,-----------------------------------------.             ,-----------------------------------------.
  ...
  [_LOWER] = LAYOUT( \
      ...
      CTLTAB,  KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,                     KC_F6,   KC_UNDS, KC_PLUS, KC_LCBR, KC_RCBR, KC_DQT, \
      _______, KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11,                    KC_F12,  KC_DQT,  _______, KC_LBRC, KC_RBRC, _______, \
      _______, _______, _______, _______, _______, _______, _______, _______, _______, KC_DEL,  _______, KC_LT,   KC_GT,   _______ \
      ),

  /* Raise
   * ,-----------------------------------------.             ,-----------------------------------------.
   * | Tab  |   1  |   2  |   3  |   4  |   5  |             |   6  |   7  |   8  |   9  |   0  |CtlSpc|
   * |------+------+------+------+------+------|             |------+------+------+------+------+------|
   ...
   */
  [_RAISE] = LAYOUT( \
      KC_TAB,  KC_1,    KC_2,    KC_3,    KC_4,    KC_5,                      KC_6,    KC_7,    KC_8,    KC_9,    KC_0,    CTLSPC,  \
      CTLTAB,  _______, KC_HOME, KC_PGDN, KC_PGUP, KC_END,                    KC_LEFT, KC_DOWN, KC_UP,  KC_RIGHT, _______, _______, \
      _______, _______, _______, _______, _______, _______,                   _______, _______, _______, _______, _______, _______, \
      _______, _______, _______, _______, _______, _______, CTLSPC, _______, _______, KC_DEL,  _______, _______, _______, _______ \
      ),

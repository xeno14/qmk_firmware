...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
   ...
   * |Shift |   Z  |   X  |   C  |   V  |   B  |             |   N  |   M  |   ,  |   .  |   /  |  '   |
   * |------+------+------+------+------+------+-------------+------+------+------+------+------+------|
   * |Adjust| GUI  | Alt  |AltCtl|Shift |Lower |Space |Enter |Raise | Bksp |   =  |   `  |   [  |  ]   |
   * `-------------------------------------------------------------------------------------------------'
   */
...
[_QWERTY] = LAYOUT( \
      ...
      ADJUST,  KC_LGUI, KC_LALT, LALTCTL, KC_LSFT, LOWER, KC_SPC,  KC_ENT,  RAISE, KC_BSPC, KC_EQL,  KC_GRV,  KC_LBRC, KC_RBRC  \
      ),
  /* Colemak
   * ,-----------------------------------------.             ,-----------------------------------------.
   ...
   */
  [_ADJUST] =  LAYOUT( \
      RESET,   _______, _______, _______, _______, _______,                   _______, _______, _______, _______, _______, CAD,     \
